<!-- filepath: resources/views/mahasiswa/dashboard.blade.php -->
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <div class="main-content">
        <div class="topbar">
            <div class="welcome">Selamat Datang {{ session('user')->username ?? '' }}</div>
            <form method="POST" action="/logout" style="margin:0;">
                @csrf
                <button class="logout-btn" type="submit">Logout</button>
            </form>
        </div>
        <button class="buat-kelompok-btn" onclick="showModal()"
            @if ($kelompok->count() > 0) disabled style="opacity:0.5;cursor:not-allowed;" @endif>
            Buat Kelompok
        </button>
        <table>
            <thead>
